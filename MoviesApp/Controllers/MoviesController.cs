...
namespace MoviesApp.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var movies = _mapper.Map<IEnumerable<Movie>, IEnumerable<MovieViewModel>>(_context.Movies.Include(m => m.ActorMovies).ToList());
            return View(movies);
        }
        ...
        public IActionResult Details(int? id)
        {
            ...
            var viewModel = _context.ActorMovies.Include(am => am.Actor).Include(am => am.Movie).Where(am => am.Movie.Id == id).Select(m => new MovieViewModel
            {
                Id = m.Movie.Id,
                Genre = m.Movie.Genre,
                Price = m.Movie.Price,
